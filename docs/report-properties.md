...
| level                         | String           | Level of message. Possible values are `error` when user must change things, `warning` when user may need to change things and `info` otherwise. | Required     |

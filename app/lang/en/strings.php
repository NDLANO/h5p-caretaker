...
$string["efficiency:imageRecommendedSize"] = "For this image type, we recommend a maximum file size of %s bytes in a web based context.";
...
$string["efficiency:imageScaleDownHeightZoom"] = "The image could be scaled down to a height of %d pixels, but people who zoom into the page may experience a visual quality loss.";
...
$string["efficiency:imageScaleDownWidthZoom"] = "The image could be scaled down to a width of %d pixels, but people who zoom into the page may experience a visual quality loss.";
...
$string["license:addSource"] = "Add the link to the content in the metadata.";

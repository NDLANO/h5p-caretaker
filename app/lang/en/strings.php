...
$string["efficiency:imageRecommendedSize"] = "For this image type, we recommend a maximum file size of %s bytes in a web based context. Currently, the size is %s bytes.";
